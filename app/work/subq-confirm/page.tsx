...
export default function SubQConfirmCaseStudy() {
  return (
    <>
      ...
      <main>
        {/* 01 — Overview */}
        <section className={`container ${styles.section} ${styles.s1}`}>
          <SectionHeading
            kicker="01 — OVERVIEW"
            title="SubQ-Confirm"
        ...
        {/* 02 — The problem */}
        <section
          className={`theme-light container ${styles.section} ${styles.s2}`}
        >
          <SectionHeading
        ...
        {/* 03 — The solution */}
        <section className={`container ${styles.section} ${styles.s3}`}>
          <SectionHeading
        ...
        <section
          className={`theme-light container ${styles.section} ${styles.s4}`}
        >
          <SectionHeading
        ...
        {/* 05 — Evidence & risk */}
        <section className={`container ${styles.section} ${styles.s5}`}>
          <SectionHeading
        ...
        {/* 06 — Go-to-market */}
        <section
          className={`theme-light container ${styles.section} ${styles.s6}`}
        >
          <SectionHeading
        ...
        <section className={`container ${styles.section} ${styles.s7}`}>
          <SectionHeading
